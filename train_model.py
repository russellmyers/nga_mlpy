...
def get_args():
    ...
    parser.add_argument('--hidden-layers',nargs="*",type=int, dest='hp_hidden_layers', default=[100], help='neural network hidden layers')
    parser.add_argument('--iters' , type=int, dest='hp_iters', default=1000, help='num iterations')
    parser.add_argument('--iso-num-estimators',type=int, dest='hp_iso_num_estimators',default=200, help='Isolation Forest hyperparameter - num estimators')
    parser.add_argument('--iso-max-samples',type=str, dest='hp_iso_max_samples',default='auto', help='Isolation Forest hyperparameter - max samples')
    parser.add_argument('--iso-max-features', type=str, dest='hp_iso_max_features', default='1.0', help='Isolation Forest hyperparameter - max features')
